...
public class TestMyTrieSet {
    ...
    public void testAdd() {
        MyTrieSet t = new MyTrieSet();
        String[] strings = new String[]{"a", "awls", "sam", "sad", "same", "sap"};
        for (String s : strings) {
            t.add(s);
        }
        assertTrue(t.contains("a"));
        assertTrue(t.contains("awls"));
        assertTrue(t.contains("sam"));
        assertTrue(t.contains("sad"));
        assertTrue(t.contains("same"));
        assertFalse(t.contains("sa"));
        assertFalse(t.contains("aw"));
        assertFalse(t.contains("awl"));
        assertFalse(t.contains("wl"));
    }
    ...
    public void testPrefix() {
        ...
        List<String> results = t.keysWithPrefix("am");
